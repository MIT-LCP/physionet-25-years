...
OUT_DIR = "natmed_2025_pdfs"

# Be polite
REQUEST_DELAY = 1.0  # seconds between requests
HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; NatMedDownloader/1.0; +https://example.org/)"
}
...
def find_article_links_in_index(html):
    ...
    for h3 in soup.find_all("h3"):
        ...
        if not a:
            continue
        href = a["href"]
        # Nature Medicine research articles are under /articles/<something>
        if "/articles/" in href:
...
def derive_filename_from_article_url(article_url):
    ...
    Example:
        ...
        -> s41591-025-04012-y.pdf
    """
    path = urlparse(article_url).path  # e.g. "/articles/s41591-025-04012-y"
...
def main():
    ...
    print(f"[info] Found {len(all_articles)} article URLs in 2025 index.")
